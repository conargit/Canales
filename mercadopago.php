...
function manejarCerrarIndividual($db) {
    ...
    registrarEnOperaciones($db, $d['id'], $d['comprador'], $d['destino'], 'delivered', $d['lat'], $d['lon'], 'cierre_bypass', 'ok', ['api'=>'shipped->delivered']);
...
<body>
    <div class="hero shadow-lg">
        ...
        <a href="?action=demo" class="btn btn-primary btn-lg px-5 py-3 rounded-pill fw-bold">ENTRAR AL SISTEMA</a>
    </div>
</body>
</html>
<?php
